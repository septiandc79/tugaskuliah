        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">Septian Dwi Cahyo</a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item">
                            <a href="<?= site_url('mahasiswa/index') ?>" class="nav-link">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-12">
                            <ol class="breadcrumb float-sm">
                                <li class="breadcrumb-item"><a href="<?= base_url() ?>"><?= $judule;
                                                                                        $this->renderSection('judul'); ?></a></li>
